...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection):
        ...
        # target postion is an array of (north, east, altitude, heading)
    ...
    # Take control of the drone and aim it for the takeoff
    # arm the drone to put it in a state ready for takeoff. Until the drone is armed, no motor related commands will be executed
...
if __name__ == "__main__":
    ...
    # Establish connection with drone and then use the drone class here wrapped in MotionPlanning to control the drone
